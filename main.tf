...
variable "ExecutionRole" {
  ...
  default     = "arn:aws:iam::517716713836:role/ECSTaskExecutionRole"
}
...
variable "FalconImagePath" {
  ...
  default     = "517716713836.dkr.ecr.ca-central-1.amazonaws.com/falcon-container-sensor:6.56.0-3903.container.x86_64.Release.US-1"
}
variable "FalconCID" {
  type        = string
  description = "CrowdStrike Customer ID (CID) value"
  default     = "5F04C49B4B944E50AF388B7B442DD564-2A"
}
variable "LogGroup" {
  type        = string
